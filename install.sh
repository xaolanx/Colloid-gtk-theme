...
SCHEME_VARIANTS=('' '-Nord' '-Dracula' '-Gruvbox' '-Everforest' '-Catppuccin' '-Kanagawa')
...
OPTIONS:
  ...
  --tweaks                Specify versions for tweaks
                          1. [nord|dracula|gruvbox|everforest|catppuccin|Kanagawa|all]  (Nord/Dracula/Gruvbox/Everforet/Catppuccin/Kanagawa/all) ColorSchemes version
